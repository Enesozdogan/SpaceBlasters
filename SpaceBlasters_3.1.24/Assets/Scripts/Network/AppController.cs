...
public class AppController : MonoBehaviour
{
    ...
    [SerializeField] private NetworkObject soldierPrefab;
    ...
    private async Task LaunchMachineType(bool isDedicatedServer)
    {
        ...
        else
        {
            ...
            hostSingleton.InstantiateHostManager(soldierPrefab);
    ...
    IEnumerator LoadGame(SingletonServer serverSingleton)
    {
       AsyncOperation asyncOp = SceneManager.LoadSceneAsync(GameScene);
        ...
        Task instantiateManager=  serverSingleton.InstantiateServerManager(soldierPrefab);
