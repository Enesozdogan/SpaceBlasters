...
public class GameManagerServer : IDisposable
{
    ...
    public GameManagerServer(string server_ip, int server_p, int qport, NetworkManager networkManager, NetworkObject soldierPrefab)
    {
        this.server_ip = server_ip;
        server_port = server_p;
        query_port = qport;
        ServerNetworking = new ServerNetworking(networkManager, soldierPrefab);
